...
object StringResource {
    ...
    const val REFRESH_TOKEN_NOT_FOUND = "Refresh token not found! Try again later"
    ...
    const val USER_SUCCESSFULLY_AUTHENTICATE = "Successful authenticate!"
    const val USER_REGISTRATION_ERROR = "Successful registration!"
